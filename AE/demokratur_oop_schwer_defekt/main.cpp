...
// defines what is common in the world of Demokratur
class worldsetup {
...
class showpeople : protected worldsetup {

public:

    showpeople(int number_of_people = 0, int number_of_rows = 0) {
    ...
    void PrintConfig() {
        ...
        std::cout << "[demokratur] [class showpeople] Dumping poeple array ..." << std::endl;
        if (people!=NULL) {
            for (int i=0; i<number_of_people_; i++) {
                std::cout << "[demokratur] [class showpeople] Person #: " << i << "is set to: " << people[i] << std::endl;
            }
        } else {
            std::cout << "[demokratur] [class showpeople] people array is empty!" << std::endl;
        }
        std::cout << "[demokratur] [class showpeople] ... dumping poeple array done." << std::endl << std::endl;
    }
...
class interaction : protected worldsetup {

public:
    interaction(int number_of_people = 0, int number_of_rows = 0)  {
        number_of_people_ = number_of_people;
        number_of_rows_ = number_of_rows;
        people = NULL;
        PrintConfig();
    ...
    void PrintConfig() {
        ...
        std::cout << "[demokratur] [class interaction] Dumping poeple array ..." << std::endl;
        if (people!=NULL) {
            for (int i=0; i<number_of_people_; i++) {
                std::cout << "[demokratur] [class interaction] Person #: " << i << "is set to: " << people[i] << std::endl;
            }
        } else {
            std::cout << "[demokratur] [class interaction] people array is empty!" << std::endl;
        }
        std::cout << "[demokratur] [class interaction] ... dumping poeple array done." << std::endl << std::endl;
    };
...
public:
    ...
    void PrintConfig() {
        ...
        std::cout  << std::endl << "[demokratur] [class talkandconvinc]  config: " << std::endl;
        std::cout << "[demokratur] [class talkandconvinc]            number_of_people_ = " << number_of_people_ << std::endl;
        std::cout << "[demokratur] [class talkandconvinc]            number_of_rows_   = " << number_of_rows_  << std::endl << std::endl;
        std::cout << "[demokratur] [class talkandconvinc] Dumping poeple array ..." << std::endl;
        if (people!=NULL) {
            for (int i=0; i<number_of_people_; i++) {
                std::cout << "[demokratur] [class talkandconvinc] Person #: " << i << "is set to: " << people[i] << std::endl;
            }
        } else {
            std::cout << "[demokratur] [class talkandconvinc] people array is empty!" << std::endl;
        }
        std::cout << "[demokratur] [class talkandconvinc] ... dumping poeple array done." << std::endl << std::endl;
    }

    int * GetPeople() { return interaction::people; }
    ...
    void gameloop() {
        ...
        if (talkerwasconvinced != 0) {
            people[talker] = interaction::people[convincer];
        }
    }
    ...
    bool checkpeople() {
        ...
        int party = interaction::people[0];
        for (int i=1; i<interaction::number_of_people_; i++) {
            if (interaction::people[i] != party) {
                dictatorship = false;
                break;
            }
        }
...
int main(int argc, char **argv) {
 ...
 try {
     ...
     if (TestingMode) {
         std::cout << std::endl << "[demokratur] Dumping all data members ..." << std::endl;
         world.PrintConfig();
         std::cout  << "[demokratur] ... dumping all data members done." << std::endl;
